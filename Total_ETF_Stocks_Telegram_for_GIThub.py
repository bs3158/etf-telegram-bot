...
def report_pension():
    portfolio = [
        ("IRP", "KODEX 200 TR", "278530", 153, 19754),
        ("IRP", "ACE 미국 나스닥100 미국채 혼합 50 액티브", "438100", 88, 14621),
        ("IRP", "TIGER 미국 배당 다우존스", "458730", 85, 13117),

        ("Pension", "TIGER KRX 금현물", "0072R0", 197, 12211),
        ("Pension", "KODEX 미국 배당커버드콜액티브", "441640", 587, 13208),
        ("Pension", "TIGER 미국 S&P500", "360750", 128, 23556),

        ("ISA", "KODEX 금융 고배당 TOP10 타겟 위클리 커버드콜", "498410", 28, 14260),
