...
def report_jonghak():
    ...
    portfolio = [
        ...
        ("KIWOOM 국고채10년", "148070", 76, 115909),
        ("KODEX 200TR", "278530", 575, 15176),
        ("TIGER 미국 S&P500", "360750", 413, 21355),
        ("ACE 미국달러SOFR금리(합성)", "456880", 759, 11582),
    ]
...
def report_pension():
    portfolio = [
        ("IRP", "ACE 미국 S&P500", "360200", 41, 24765),
        ("IRP", "ACE 미국 나스닥100 미국채 혼합", "438100", 88, 14621),
        ("IRP", "TIGER 미국 배당 다우존스", "458730", 84, 13100),

        ("Pension", "TIGER KRX 금현물", "0072R0", 197, 12211),
        ("Pension", "KIWOOM 국고채10년", "148070", 15, 113824),
        ("Pension", "KODEX 200TR", "278530", 153, 19754),
        ("Pension", "TIGER 미국 S&P500", "360750", 128, 23556),
        ("Pension", "ACE 미국달러SOFR금리(합성)", "456880", 144, 11863),

        ("ISA", "TIGER 미국 S&P500", "360750", 6, 25045),
        ("ISA", "TIGER 미국나스닥100", "133690", 2, 164130),
        ("ISA", "TIGER 200", "102110", 3, 70510),
    ]
